...
<template>
    ...
    <div class="layout-main-container flex min-h-screen flex-col items-center lg:justify-center lg:p-8">
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                <Button v-if="$page.props.auth.user" asChild v-slot="slotProps">
                    <Link :href="route('dashboard')" :class="slotProps.class">Dashboard</Link>
                </Button>
                <template v-else>
                    <Button asChild v-slot="slotProps" severity="secondary">
                        <Link :href="route('login')" :class="slotProps.class">Log in</Link>
                    </Button>
                    <Button asChild v-slot="slotProps">
                        <Link :href="route('register')" :class="slotProps.class">Register</Link>
                    </Button>
                </template>
            </nav>
        </header>
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row"
                ...
                <div
                    class="flex-1 rounded-bl-lg rounded-br-lg p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] bg-surface-0 dark:bg-surface-900 dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-br-none lg:rounded-tl-lg lg:p-20"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span class="relative bg-surface-0 dark:bg-surface-900">
                                <span
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <Button as="a" label="Deploy now" href="https://cloud.laravel.com" target="_blank" />
                        </li>
                    </ul>
                </div>
                <div
